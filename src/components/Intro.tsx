      ...
      <div className="flex-1 flex items-center justify-center px-5 py-10">
        <div className="w-full max-w-5xl grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="relative order-1 md:order-none">
            <div className="absolute -inset-3 bg-accent/10 rounded-3xl rotate-2" />
            <img
              key={index}
              src={TEACHER_PHOTO}
              alt="Преподаватель"
              className="relative w-full aspect-[4/5] object-cover rounded-3xl shadow-2xl animate-fade-in"
            />
          </div>
          ...
          <div key={slide.title} className="animate-slide-up">
            ...
            <h1 className="font-display text-5xl md:text-6xl font-bold text-foreground mt-4 leading-tight">
              {slide.title}
            </h1>
